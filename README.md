...
These are suggested, general instructions, based on Ubuntu 20.04.  You will likely need to adapt for your environment.

## Put script in place
Download script copy/move it to a cron-schedued directory:
```
